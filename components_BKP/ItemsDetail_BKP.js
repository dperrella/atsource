...
class ItemsDetail extends Component {
  ...
  selectPhotoTapped() {
    ...
    ImagePicker.showImagePicker(options, (response) => {
      ...
      if (response.didCancel) {
        ...
        fetch(urlSetPhoto, {
          method: "POST",
          body: this.createFormData(response, { type:'I',idItem: this.state.itemId })
        })
          .then(res => res.json())
          .then(res => {
            console.log("upload succes", res);
            alert("Upload success!");
            this.setState({ photoIn: null });
          })
          .catch(error => {
  ...
  fetchPhoto() {
    ...
    fetch(urlSetPhoto, {
      method: "POST",
      body: this.createFormData(this.state.photoIn, { type:'I',idItem: this.state.itemId })
    })
      .then(res => res.json())
      .then(res => {
        console.log("upload succes", res);
